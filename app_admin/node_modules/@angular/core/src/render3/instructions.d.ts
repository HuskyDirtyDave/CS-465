...
import { ComponentDefInternal, ComponentQuery, ComponentTemplate, DirectiveDefInternal, DirectiveDefListOrFactory, InitialStylingFlags, PipeDefListOrFactory, RenderFlags } from '@angular/core/src/render3/interfaces/definition';
import { LInjector } from '@angular/core/src/render3/interfaces/injector';
import { LContainerNode, LElementNode, LNode, LProjectionNode, LTextNode, LViewNode, TAttributes, TContainerNode, TElementNode, TNode, TNodeType } from '@angular/core/src/render3/interfaces/node';
...
import { CurrentMatchesList, LViewData, LViewFlags, RootContext, TView } from '@angular/core/src/render3/interfaces/view';
/**
